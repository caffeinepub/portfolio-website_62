...
export class Backend implements backendInterface {
    ...
    async addSkill(arg0: string, arg1: Skill): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createPortfolio(arg0: string, arg1: string, arg2: Array<Skill>, arg3: Array<Project>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createPortfolio(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
